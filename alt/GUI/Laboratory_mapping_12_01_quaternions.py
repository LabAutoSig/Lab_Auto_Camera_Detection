#path to your FreeCAD.sp or FreeCAD.pyd file
...
def import_object_in_HORST_world(Horst_path, object_path, new_file_name):
    ...
    App.getDocument(document.Name).saveAs("Horst_with_object_new2.step")
...
img1 = cv2.imread('C:\\Users\\wienbruch\\venv38\\images\\16_08\\-x_h1\\1.jpg')#modified
camera_pose_file1 = 'C:\\Users\\wienbruch\\venv38\\images\\16_08\\-x_h1\\camera_pose1.txt'#Load camera pose1 from txt files
...
img2 = cv2.imread('C:\\Users\\wienbruch\\venv38\\images\\16_08\\-x_h1\\2.jpg')#modified
camera_pose_file2 = 'C:\\Users\\wienbruch\\venv38\\images\\16_08\\-x_h1\\camera_pose2.txt' #Load camera pose2 from txt files
