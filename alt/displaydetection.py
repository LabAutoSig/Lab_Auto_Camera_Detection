...
def data_processing():
    ...
    # Path to your AutoIt script8
    autoit_script_path = r'display_detection\data_processing.au3'
    data_folder_name = 'output.csv'

    # Build the command to execute with the output folder path as a command-line argument
    command = [autoit_exe_path,  autoit_script_path,autoit_SciTe_path, data_folder_name]
...
img_path = r"C:\Users\wienbruch\camera_detection_system\display_detection\Input_img\rawimg.jpg"
#r"C:\Users\wienbruch\venv311\Detection_system_06_02_24\Input_img\Variation_lighting\rawimg102.jpg"
img = cv2.imread(img_path)
#cv2.imshow("img",img)
#Define the model path 
yolo_path = r"display_detection\Trained_model\Model_2_3_4_best.pt"
