...
def read_chessboards(images, board): #input images and board data
    ...
    """
    savepath = r'Camera_Calibration\Calibrated_Images\ '
...
calibration_images_folder = r'Camera_Calibration\Calibration_images'
...
np.savez("Camera_calibration\calibration_parameters.npz", camera_matrix=mtx, dist_coeffs=dist)
